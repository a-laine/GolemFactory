...
typedef glm::tvec4<glm::f32, glm::simd> glm_vec4f;
#else
typedef glm::fvec4 glm_vec4f;
#endif


typedef glm::fvec3 glm_vec3f;
typedef glm::fvec2 glm_vec2f;

#ifdef GLM_FORCE_AVX2
typedef glm::tquat<glm::f32, glm::simd> glm_quatf;
#else
typedef glm::fquat glm_quatf;
#endif

#ifdef GLM_FORCE_AVX2
typedef glm::tmat4x4<glm::f32, glm::simd> glm_mat4f;
#else
typedef glm::fmat4 glm_mat4f;
#endif

typedef glm::ivec4 glm_vec4i;
typedef glm::ivec3 glm_vec3i;
typedef glm::ivec2 glm_vec2i;
typedef glm::bvec4 glm_vec4b;
typedef glm::uvec4 glm_vec4ui;

...
glm::vec3 Shape::support(const glm::vec3& direction) const { return glm::vec3(0.f); }
void Shape::getFacingFace(const glm::vec3& direction, std::vector<glm::vec3>& points) const {}
